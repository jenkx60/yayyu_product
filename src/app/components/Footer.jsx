    ...
    <div className=''>
        <footer className='bg-footer text-black font-dmSans py-7'>
            <div className=' flex flex-col lg:flex-row justify-center lg:justify-evenly gap-8 '>
                ...
                <div>
                    <h1 className='font-medium text-base leading-5 pb-3'>FOLLOW US ON</h1>
                ...
                <div>
                    ...
                    <form>
                        <input type='email' placeholder='Email Address' className='py-4 w-96 mb-2 placeholder:my-5 placeholder:text-sm placeholder:container' required/>
                    </form>
