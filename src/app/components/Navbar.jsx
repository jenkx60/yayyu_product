...
import { FaAngleDown, FaRegUser, FaRegHeart, FaSistrix, FaBars } from 'react-icons/fa6';
...
const Navbar = () => {
  ...
  return (
    <div>
        <nav className='bg-white w-full h-auto flex justify-between items-center p-5'>
            {/* Mobile Menu Button */}
            <button onClick={toggleMobileMenu} className='md:hidden text-black text-2xl'>
            ...
            <div className='hidden md:flex-1 gap-5 text-black font-dmSans text-sm font-normal md:justify-start'> 
                <Link href='/'>HOME</Link>
            ...
            {/* cart section */}
            <div className=' md:flex text-black text-2xl gap-5'>
                <FaRegUser className='hidden'/>
                <FaRegHeart className='hidden'/>
                <FaSistrix className='hidden'/>
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
            <div className='md:hidden bg-white text-black p-5'>
